...
def salvar_no_minio(df):
    ...
    try:
        caminho_csv = "/app/data/linhas_zona_leste.csv"
        ...
        destino = "bronze/linhas_zona_leste.csv"
...
def buscar_linhas_zona_leste():
    ...
    termos_zona_leste = [
        "Itaquera", "São Miguel Paulista", "Ermelino Matarazzo", "Guaianases",
        "Artur Alvim", "Vila Matilde", "Penha", "Tatuapé", "Belém",
        "Parque do Carmo", "Cidade Tiradentes", "José Bonifácio",
        "Terminal São Miguel", "Terminal Itaquera", "Terminal Cidade Tiradentes"
    ]

    dfs = []

    for termo in termos_zona_leste:
    ...
    if dfs:
        ...
        print("⚠️ Nenhuma linha encontrada para os termos da Zona Leste.")
