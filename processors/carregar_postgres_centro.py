...
def carregar_do_minio_para_postgres():
    ...
    objeto = "bronze/linhas_zona_central.csv"
    caminho_local = "/tmp/linhas_zona_central.csv"
    ...
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS linhas_zona_central (
    ...
    for _, row in df.iterrows():
        cursor.execute("""
            INSERT INTO linhas_zona_norte (cl, lc, lt, sl, tp)
            VALUES (%s, %s, %s, %s, %s)
